  ...
  render() {
    return (
      <div>
        ...
        <div className="col-12 p-0">
          <div className="col-12 p-0">
            <div className="d-flex" style={{justifyContent: 'space-between'}}>
              ...
              <span className="exp_date text-right">April 2020 - Present</span>
            </div>
        ...
        <Parallax.Layer offset={1.45} speed={0.5} style={{ display: 'flex', flexDirection:"column", alignItems: 'flex-start', justifyContent: 'start', flexWrap: 'wrap', padding:' 1% 5%' }}>
        <div className="col-12 p-0">
          <div className="col-12 p-0">
            <div className="d-flex" style={{justifyContent: 'space-between'}}>
        ...
        <Parallax.Layer offset={1.75} speed={0.75} style={{ display: 'flex', flexDirection:"column", alignItems: 'flex-start', justifyContent: 'start', flexWrap: 'wrap', padding:' 1% 5%' }}>
        <div className="col-12 p-0">
          <div className="col-12 p-0">
            <div className="d-flex" style={{justifyContent: 'space-between'}}>
