...
<Parallax.Layer
           offset={0}
          speed={0.45}
          style={{ display: 'flex', flexDirection:"column", alignContent: 'center', justifyContent: 'center',zIndex:5,padding:'0 4%', marginTop:'-2%'}}>
...
<Parallax.Layer
          ...
          <p style={{marginBottom:'7vmin'}}>MERN-stack developer (MongoDB/MySQL Express React Node). I enjoy making web apps in REACT. <br/>My next challenge is to use REACT-NATIVE and PWAs to build mobile apps.
          {/* <br/>
