...
export class AboutMe extends React.Component {
	constructor(props) {
		super(props);
		this.diff = new Date() - new Date(2018, 10, 20);
		...
		return (
			<div style={{ alignContent: 'space-between' }}>
				<Parallax.Layer offset={0} speed={0.75} style={{ display: 'flex', flexDirection: "column", alignContent: 'center', justifyContent: 'center', zIndex: 5, padding: '0 5%', marginTop: '2%' }}>
					...
					<p> {`Welcome! I'm a software engineer with ${this.qualifier} ${Math.round((this.years))} years of experience. I currently work at Sportsengine, where I do front-end development in an agile team using Angular. Please continue for more info.`}</p>
				</Parallax.Layer>
			</div>
		)
	}
